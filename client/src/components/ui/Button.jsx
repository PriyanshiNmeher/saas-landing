...
const Button = ({
  ...
  text_color = "#ffffff",
  fill_background = "linear-gradient(131deg",
  ...
  const hasValidFillBackgroundColor = fill_background_color && typeof fill_background_color === 'string' && fill_background_color?.trim() !== '';
  ...
  const buttonStyles = {
    ...
    background: hasValidFillBackgroundColor ? fill_background_color : fill_background,
