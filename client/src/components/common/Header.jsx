...
//           {/* Logo Section */}
//           <div className="flex items-center gap-2.5 w-auto md:mx-0">
//             <img 
...
//             <button
//               role="menuitem"
//               className="text-xs sm:text-sm font-normal leading-tight text-text-secondary hover:text-text-primary transition-colors duration-200 px-2 py-1"
//               style={{
//                 fontSize: '16px',
//                 fontFamily: 'Poppins',
//                 fontWeight: '400',
...
//             <button
//               role="menuitem"
//               className="px-4 sm:px-6 md:px-7 py-2 sm:py-2.5 rounded-xs text-xs sm:text-sm font-normal leading-tight text-text-primary transition-all duration-200 hover:opacity-90"
//               style={{
//                 fontSize: '16px',
//                 fontFamily: 'Poppins',
//                 fontWeight: '400',
